...
def get_gmails(userId):
    ...
    test_start_date = int(datetime(2021, 10, 12).timestamp())
    test_end_date = int(datetime(2021, 10, 15).timestamp())
    date_query = "after:{0} before:{1}".format(test_start_date, test_end_date)

    from_query = "from: {roymongyue@gmail.com yashyog2012@gmail.com willkao21@gmail.com}"
